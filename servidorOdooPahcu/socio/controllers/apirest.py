...
class ApiRest(http.Controller):
    ...
    Valor de data: {"dni":"3", "nombre":"Pascual","Apellidos":"Garcia"}
    URL COMPLETA (Enviada con POST): http://localhost:8069/gestion/apirest/socio?data={"dni":"3", "nombre":"Pascual","apellidos":"Garcia"} 

    --------------
    Probar PUT/PATCH (Modificar socio 3)
    Valor de data: {"dni":"3", "nombre":"Pascual","apellidos":"NuevoApellido"}

    URL COMPLETA (Enviada con PUT/PATCH): http://localhost:8069/gestion/apirest/socio?data={"dni":"3", "nombre":"Pascual","apellidos":"NuevoApellido"} 

    '''


    #Definimos la operacion para metodos POST, PUT y MATCH
    #192.168.1.120:8069/socio/socio?data={"dni":"3", "nombre":"Pascual","apellidos":"Garcia"}

    @http.route('/<model>', auth="none", cors='*', csrf=False,
    ...
    Valor de data: {"dni":"3"}
    URL COMPLETA (Enviada con GET): http://localhost:8069/gestion/apirest/socio?data={"dni":"3"} 

    --------------
    Probar DELETE (Borrando socio 3)
    Valor de data: {"dni":"3"}

    URL COMPLETA (Enviada con DELETE): http://localhost:8069/socio?data={"dni":"3"} 

    '''
    @http.route('/<model>', auth="none", cors='*', csrf=False, methods=["GET", "DELETE"],
                type='http')
